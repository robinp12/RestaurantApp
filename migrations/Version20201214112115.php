 ...
 */
final class Version20201214112115 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD product_id INT DEFAULT NULL, CHANGE total_amount total_amount INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP product_id, CHANGE total_amount total_amount DOUBLE PRECISION NOT NULL');
    }
}
